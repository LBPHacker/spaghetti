...
local function merge_parts(x, y, parts_out, parts_in, storage_remap)
...
local function create_parts(x, y, parts_in, storage_remap, debug)
	return misc.user_wrap(function()
		return create_parts_(x, y, parts_in, storage_remap, debug)
	end)
end
...
local function plan(x, y, plan, extra, storage_remap, debug)
	return misc.user_wrap(function()
		local parts = partsify_plan(plan, extra)
		create_parts_(x, y, parts, storage_remap, debug)
	end)
end
